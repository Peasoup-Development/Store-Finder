...
class ImageUploader
{
    ...
    public function __construct(
        ...
        $this->logger = $logger;
        $this->baseTmpPath = "storefinder/tmp/store";
        $this->basePath = "storefinder/store";
    ...
    public function checkIfNew($file){
        $basePath = $this->getBasePath();

        $filepath =  $this->mediaDirectory->getAbsolutePath().$basePath."/".$file;
